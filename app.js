(function() {
  ...
  document.addEventListener('focusin', function(e) {
    if (['INPUT','TEXTAREA','SELECT'].includes(e.target.tagName)) { lastScrollY = window.scrollY; }
  });
  document.addEventListener('focusout', function() { window.scrollTo(0, lastScrollY); });
})();
